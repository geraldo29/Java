...
When you execute the program a simple menu will appear. You will have four choices (1,2,3,4). If you enter three numbers not equal to 1,2,3, or 4, the program will terminate. 

Number Menu
From the main menu, if you enter 1 you will enter the Numbers Menu. Their again you will have the choice of three diferent options (1,2,3). You only have three choices. If you enter three numbers not equal to 1,2, or 3, you will be sent back to main menu.
Case 1:
...
String Menu
From the Main menu if you enter 1, you will enter the String Menu. Here you are presented with three option (1,2,3). You have three tries, If you enter three numbers not equal to 1,2, or 3. The program will return to the main menu. 
Case 1: 
